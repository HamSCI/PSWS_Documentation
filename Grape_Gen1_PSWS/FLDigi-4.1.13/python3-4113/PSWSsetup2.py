...
################################################################
################################################################
print('\n\nGrape Gen 1 Personal Space Weather Station (PSWS) Setup Program Ver 1.00\n\n')
################################################################
...
Done = 0
while Done == 0:
    print('Enter New Frequency Standard [XTAL, TCXO, OCXO, GPSDO, Rubidium, Cesium, Custom]')
