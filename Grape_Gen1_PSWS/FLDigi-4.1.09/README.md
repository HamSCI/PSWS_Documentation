...
## FLDigi_4.1.09 waa the first customized release for data collection

- Based on the Gen 1 harware receiver
- Used a modified version of FLDIGI-4.1.09 for data collection 
- Used custom pythion scripts for data handling
- Directory structure based off of home path /home/pi
- Subdirectories include /WWVdata,  
